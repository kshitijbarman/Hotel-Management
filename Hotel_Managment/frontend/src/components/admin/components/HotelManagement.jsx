...
const HotelManagement = ({
  ...
  //         <h2 className="text-xl font-semibold text-black mb-4">Manage Hotels</h2>
  //         <form onSubmit={handleHotelSubmit} className="space-y-4 mb-6">
  //             <div>
  //                 <label htmlFor="hotel-state" className="block text-sm font-medium text-black">
  //                     State
  //                 </label>
  //                 <select
  //                     id="hotel-state"
  ...
  //             </div>
  //             <div>
  //                 <label htmlFor="hotel-city" className="block text-sm font-medium text-black">
  //                     City
  //                 </label>
  //                 <select
  //                     id="hotel-city"
  ...
  //                 className={`flex-1 py-2 rounded-md ${hotelTab === "active" ? "bg-green-600 text-white" : "bg-green-700 text-gray-300"}`}
  //             >
  //                 Active
  //             </button>
  //             <button
  //                 onClick={() => setHotelTab("inactive")}
  //                 className={`flex-1 py-2 rounded-md ${hotelTab === "inactive" ? "bg-red-600 text-white" : "bg-red-700 text-gray-300"}`}
  //             >
  //                 Inactive
  //             </button>
  //         </div>
