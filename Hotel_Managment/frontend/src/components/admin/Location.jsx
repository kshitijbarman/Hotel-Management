        ...
        <div className="bg-gradient-to-r from-slate-800/90 to-blue-900/90 rounded-2xl shadow-xl p-6 text-gray-100">
          ...
          {sidebarTab === "states" && (
            <div>
              ...
              <ul className="space-y-2">
                {(stateTab === "active" ? states : inactiveStates).map(
                  (state) => (
                    <li
                      key={state._id}
                ...
                {(stateTab === "active" ? states : inactiveStates).length ===
                  0 && (
                  <li className="text-center text-gray-400 py-4">
                    No {stateTab} states found.
                  </li>
                )}
              </ul>
            </div>
          ...
          {sidebarTab === "cities" && (
            <div>
              ...
              <ul className="space-y-2">
                {(cityTab === "active" ? cities : inactiveCities).map(
                  (city) => (
                    <li
                      key={city._id}
                      className="flex justify-between items-center p-3 bg-slate-800 rounded-md border border-slate-700"
                ...
                {(cityTab === "active" ? cities : inactiveCities).length ===
                  0 && (
                  <li className="text-center text-gray-400 py-4">
          ...
          {sidebarTab === "hotels" && (
            <div>
              ...
              <ul className="space-y-2">
                {(hotelTab === "active" ? hotels : inactiveHotels).map(
                  (hotel) => (
                    <li
                      key={hotel._id}
                      className="flex justify-between items-center p-3 bg-slate-800 rounded-md border border-slate-700"
                ...
                {(hotelTab === "active" ? hotels : inactiveHotels).length ===
                  0 && (
                  <li className="text-center text-gray-400 py-4">
          ...
          {sidebarTab === "rooms" && (
            <div>
              ...
              <ul className="space-y-2">
                ...
                {(roomTab === "active" ? rooms : inactiveRooms).length ===
                  0 && (
                  <li className="text-center text-gray-400 py-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-200">
                        <div>
                          <p className="flex items-center mb-2">
                            ...
                            <strong>User:</strong> {booking.userId?.firstname}{" "}
                            {booking.userId?.lastname} ({booking.userId?.email})
                          </p>
                          <p className="flex items-center mb-2">
                            <FaBed className="mr-2 text-blue-400" />
                            <strong>Room:</strong> {booking.roomId?.roomNumber}{" "}
                            ({booking.roomId?.type})
                          </p>
                          <p className="flex items-center mb-2">
                        ...
                        <div>
                          ...
                          <p className="flex items-center mb-2">
                            ...
                            <strong>Price:</strong> ₹
                            {booking.roomId?.price || "N/A"} per night
                          </p>
                          <p className="flex items-center">
